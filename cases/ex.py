...
# WebDriverWait(driver,10).until(lambda x:x.find_element('id','loginname')).send_keys('loginname')
# WebDriverWait(driver,10).until(lambda x:x.find_element('id','nloginpwd')).send_keys('nloginpwd')
